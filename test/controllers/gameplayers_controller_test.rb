...
class GameplayersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gameplayer" do
    assert_difference('Gameplayer.count') do
      post gameplayers_url, params: { gameplayer: { eight: @gameplayer.eight, game_id: @gameplayer.game_id, player_id: @gameplayer.player_id, win: @gameplayer.win } }
    end
  ...
  test "should update gameplayer" do
    patch gameplayer_url(@gameplayer), params: { gameplayer: { eight: @gameplayer.eight, game_id: @gameplayer.game_id, player_id: @gameplayer.player_id, win: @gameplayer.win } }
